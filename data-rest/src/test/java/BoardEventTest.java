import com.hkoo.rest.DataRestApplication;
...
public class BoardEventTest {
    ...
    private TestRestTemplate testRestTemplate = new TestRestTemplate("hkoo", "test");


    @Test
    public void 저장할_때_이벤트가_적용되어_생성날짜가_생성되는가() {
